	...
	<div id="wrapper">
    	...
    	<div class="container">
			...
			<div class="row">
				...
				<div class="title"><h3>Text Editor Icons</h3></div>
				...
				<div class="title"><h3>Directional Icons</h3></div>
				<div class="row-fluid bs-icons">
				  <div class="span3">
				    <ul class="fa-icons">
				...
				<div class="title"><h3>Video Player Icons</h3></div>
				<div class="row-fluid bs-icons">
				  <div class="span3">
				    <ul class="fa-icons">
				...
				<div class="title"><h3>Social Icons</h3></div>
				<div class="row-fluid bs-icons">
				  <div class="span3">
				    <ul class="fa-icons">
